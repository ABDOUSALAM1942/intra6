...
// }
     ...
     <div class="h2p  text-center text-light">
                <div id="maDiv">
                    
                </div>
                <!-- Fenêtre modale pour afficher la description
                <div id="myModal2" class="modal2">
                    <div class="modal-content2">
                        <span class="close2">&times;</span>
                        <h2 style="font-size: 15px;">Description de la tâche</h2>
...
function loadInitialData() {
    ...
    for (let i = 0; i < storedData.length; i++) {
        ...
        <button class="btn btn-info" onclick="editData(${rowData.id})">
            <i class="fas fa-edit"></i> <!-- Icône de crayon -->
        </button>
        ...
        // // Ajoutez l'élément de l'icône de l'œil à la dernière cellule de la ligne
        // row.querySelector('td:last-child').appendChild(eyeIcon);
